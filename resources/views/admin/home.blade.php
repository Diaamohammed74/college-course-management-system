            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="{{ route('students') }}" class="small-box-footer" style="color: black;">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="info-box">
                        <span class="info-box-icon bg-dark elevation-1"><i class="ion ion-person"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Success Ratio</span>
                            <span class="info-box-number">
                                {{ number_format(($gradStudents / $students) * 100, 2) }}
                                <small>%</small>
                            </span>
                            <a href="{{ route('students') }}" class="small-box-footer" style="color: black;">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
